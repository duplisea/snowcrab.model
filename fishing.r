...
# carapace width - weight relationship for 14 instars
...
cohort.biomass= n.fishable * (weigth.at.cw/1000) # convert to kg
...
TAC= exp.rate * fishable.cohort.biomass
...
realised.exp.rate= sum(fishery.losses.by.cohort) / fish.biomass  # exploitation of the fishable population
