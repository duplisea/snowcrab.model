...
ext.death = params$ext.death      #females first column, males second
CW.9 = params$CW.9
CW.10 = params$CW.10
CW.11 = params$CW.11
...
sexe.ratio=0.5		#females/total. This is the sex ratio of fertilised eggs, not of the population
...
#write.table(abase,"d:/tmp/abase.csv",sep=";")